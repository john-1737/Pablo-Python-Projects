...
def main():
    ...
    while start:
        ...
        render_text('You can change it with the left-right keys.', (0, 400))
        render_text('Press SPACE to start!', (0, 450))
        pg.display.update()
    # Set up a new game:
    while True:
        board = getNewBoard()
        ...
        while lives and playing:  # Main game loop.
            ...
            render_text('Use arrow keys to move up, down, left, and right.', (0, (HEIGHT*20)+100))
            render_text('Use Q, W, A, and S keys to move diagonally.', (0, (HEIGHT*20)+150))
            render_text('Press SPACE to stay still.', (0, (HEIGHT*20)+200))
            if board['teleports'] > 0:
                render_text('Press ENTER to teleport.', (0, (HEIGHT*20)+250))
        ...
        while end:
            ...
            render_text('Press SPACE to play again.', (0, (HEIGHT*20)+200))
            pg.display.update()
