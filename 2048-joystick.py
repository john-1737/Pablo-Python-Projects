...
def main():
    ...
    while start_screen:
        ...
        render_text('directions with either joystick.', (0, 50), font=smallfont)
        ...
        render_text('Press R1 to start!', (0, 200), font=smallfont)
        pg.display.update()
    ...
    while True:
        ...
        while game:  # Main game loop.
            ...
            if isFull(gameBoard):
                ...
                render_text('Press circle to reset.', (0, 450), font=smallfont)
            pg.display.update()
        ...
        while endgame:
            ...
            render_text('Press R1 to play again.', (0, 475), font=smallfont)
            pg.display.update()
